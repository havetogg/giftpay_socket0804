...
public class WXShareUtil {
    ...
    private WXShareUtil(String appId, String appSceret, String type) {
        this.appId = appId;
        this.appSecret = appSceret;
        gateUrl = "https://sms.linkgift.cn";
//        gateUrl = "http://www.linkgift.cn";
    }

    public static WXShareUtil getInstance(String appId, String appSceret, String type) {
        if (null == instance)
            instance = new WXShareUtil(appId, appSceret, type);
        return instance;
    }
    ...
    private void getAccessTocken() throws Exception {
        ...
        String url =  gateUrl + "/gift_gate/getToken.action?appId=" + this.appId + "&timestamp=" + timestamp
                + "&signature=" + signature;
    ...
    private void getJsapiTicket() throws Exception {
        ...
        timestamp = System.currentTimeMillis() / 1000;
        String signature = MD5X.getLowerCaseMD5For32(this.appId + this.appSecret + timestamp);
        String url = gateUrl + "/gift_gate/getJsApiTicket.action?appId=" + this.appId + "&timestamp=" + timestamp
                + "&signature=" + signature;
