    ...
    $.ajax({
        ...
        success: function (config) {
            ...
            shareData = {
                title:"油礼付抢油",
                desc: "油礼付抢油",
                link:getRootPath()+'/loginIndexBase.htm',
